  ...
  return (
    <section className="bg-white text-center dosis-normal">
      ...
      <div className="block text-center lg:flex max-w-5xl mx-auto lg:space-x-11 mb-28">
        <img src={Studio} alt="studio-img" className="w-1/2 inline-block" />
        <div className="text-left w-1/2 mx-auto">
          ...
          <div className="flex space-x-5">
            <img src={Jack} alt="jack-wilcox" className="w-28 h-28 rounded-full border-4 border-gray-300 inline-block"/>
            <div>
